...
public class Danmaku {
    ...
    public String getApiSourceName() {
        return TextUtils.isEmpty(apiSourceName) ? "" : apiSourceName;
    }
    ...
    public String getAnimeId() {
        return TextUtils.isEmpty(animeId) ? "" : animeId;
    }
    ...
    public String getBangumiId() {
        return TextUtils.isEmpty(bangumiId) ? getAnimeId() : bangumiId;
    }
    ...
    public String getAnimeTitle() {
        return TextUtils.isEmpty(animeTitle) ? getName() : animeTitle;
    }
    ...
    public boolean isAnime() {
        return !TextUtils.isEmpty(getBangumiId()) && getUrl().isEmpty();
    }
